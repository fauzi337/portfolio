...
const gallery = [
  "/images/projects/hris/login.png",
  "/images/projects/hris/employeelist.png",
  "/images/projects/hris/absen1.png",
  "/images/projects/hris/absen2.png",
  "/images/projects/hris/payroll.png",
  "/images/projects/hris/respon_payroll.png",
  "/images/projects/hris/overtime.png",
  "/images/projects/hris/respon_overtime.png",
  "/images/projects/hris/tor.png",
  "/images/projects/hris/respon_request-time-off.png",
  "/images/projects/hris/wbs.png",
];
...
const activities = [
  ...
  },
  {
    ...
    desc: "Verified and consolidated HR master data including administrative information and structured data for the system."
  },
  {
    title: "Quick Customization",
    desc: "implemented quick customizations, including data structure configuration and feature adjustments to support HR administration and information management."
  },
  {
    title: "Led Go-Live",
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <h1 className="text-4xl font-bold mb-4">
            Human Resource <span className="text-gradient">Information System Project</span>
          </h1>

          <p className="text-muted-foreground mb-6">
           A human resource management platform that supports employee administration, attendance tracking, payroll processing, 
           overtime management, and time-off request workflows.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="text-muted-foreground space-y-2">
              <li><b>Company:</b> Freelance (Remot)</li>
              <li><b>Role:</b> Junior Developer</li>
              <li><b>Timeline:</b> Aug 2025 - Mar 2026</li>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {["Vue.js", "NestJS", "Prisma ORM", "PostgreSQL", "REST API", "Vite"].map((tech) => (
                <span
                  key={tech}

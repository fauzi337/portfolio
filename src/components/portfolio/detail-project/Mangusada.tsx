...
const gallery = [
  "/images/projects/his-rsd-mangusada/mangusada0.png",
  "/images/projects/his-rsd-mangusada/mangusada1.png",
  "/images/projects/his-rsd-mangusada/mangusada2.png",
  "/images/projects/his-rsd-mangusada/mangusada3.png",
  "/images/projects/his-rsd-mangusada/mangusada4.png",
];
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          <h1 className="text-4xl font-bold mb-4">
            Hospitality Information System <span className="text-gradient">RSD Mangusada</span>
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="text-muted-foreground space-y-2">
              ...
              <li><b>Timeline:</b> Sep 2022 - Des 2022</li>
